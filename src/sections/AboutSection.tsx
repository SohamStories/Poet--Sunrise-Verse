...
export function AboutSection() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl.fromTo(
        imageRef.current,
        { x: '-25vw', opacity: 0 }, // Reduced from -45vw
      ...
      scrollTl.fromTo(
        textRef.current,
        { x: '25vw', opacity: 0 }, // Reduced from 35vw
        { x: 0, opacity: 1, ease: 'none' },
        0.06
      );
      ...
      scrollTl.fromTo(
        imageRef.current,
        { y: 0, opacity: 1 },
        { y: '-8vh', opacity: 0, ease: 'power1.in' }, // Reduced from -12vh
        0.7
      );
      ...
      scrollTl.fromTo(
        textRef.current,
        { y: 0, opacity: 1 },
        { y: '-6vh', opacity: 0, ease: 'power1.in' }, // Reduced from -8vh
        0.7
      );
    }, section);
