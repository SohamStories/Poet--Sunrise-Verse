    ...
    <>
      ...
      >
        <div className="w-full px-5 lg:px-[6vw] py-4 lg:py-5 flex items-center justify-between">
          ...
          <a
            href="#"
            className="font-serif text-lg lg:text-xl font-medium text-white tracking-tight text-shadow"
            onClick={(e) => {
              e.preventDefault();
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 z-[99] bg-black/85 backdrop-blur-lg transition-all duration-300 lg:hidden ${
          isMobileMenuOpen
